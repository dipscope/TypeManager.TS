 ...
 * allows to define custom behaviours for type manager plugins. Custom key is a unique 
 * typed key defined in the code. It allows to get back strongly typed values.
 * 
 * @type {CustomOption}
 */
